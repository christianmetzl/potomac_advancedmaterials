...
RUNS = {
    ...
    1: ("40q H20 MPS QSCI (P1+P2+P3) — the headline",
        [PY, f"{SRC}/gpu_run1_h20_mps.py", "--atoms", "20", "--shots", "200000",
         "--topm", "256", "--grow-iters", "60", "--grow-per-iter", "1000", "--kcap", "2000000"],
        [PY, f"{SRC}/gpu_run1_h20_mps.py", "--atoms", "6", "--shots", "20000"]),
    5: ("cuStateVec exact validation sweep (<=32q)",
    ...
    4: ("CrO CAS(19,19)=38q QSCI vs same-CAS DMRG (P4)",
        [PY, f"{SRC}/gpu_run4_cro38q.py", "--ncas", "19", "--grow-iters", "80", "--kcap", "500000"],
